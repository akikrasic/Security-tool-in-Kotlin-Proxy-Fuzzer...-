...
class UcitavanjeWebSocketa(val ulaz: InputStream, val izlaz: OutputStream, val url:String, val koSalje:String): UcitavanjeZajednicko(ulaz, izlaz) {
    ...
    suspend fun ucitajteWebSocketPorukuIPrepisite() {
        ...
        while (true) {
            ...
            val fin = daLiJeBajtPostavljen (prviInt, 128)//prviInt and 128)==128//(prviBajt and 128.toByte() ) == 128.toByte()
